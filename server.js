...
app.post('/api/empreendimento-construtora', upload.fields([
  ...
  try {
    ...
    const memorialDescritivoPath = req.files['memorial_descritivo'] ? req.files['memorial_descritivo'][0].path : null;
    const projetoTelefoniaPath = req.files['projeto_telefonia'] ? req.files['projeto_telefonia'][0].path : null;
    ...
    await executarQuery(
      ...
      [
        ...
        telefone_responsavel,
        email_responsavel,
        memorialDescritivoPath,
        projetoTelefoniaPath,
        endereco_stand,
        data_inicio_vendas,
        data_fim_vendas,
        nome_responsavel_stand,
